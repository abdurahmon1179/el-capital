<template>
    <section class="bg-[#002B5B0D] py-[120px]">
        <Container>
            <h1 class="text-[36px] font-semibold pb-[20px]">Сўнгги янгиликлар</h1>
            <p class="text-[24px] leading-[135%] w-[900px] pb-[80px]">Капитал бозоридаги сўнгги янгиликлар, қонунчиликдаги ўзгаришлар
                ва инвестиция имкониятлари ҳақида қисқа ва ишончли маълумотлар жамланади.
            </p>
